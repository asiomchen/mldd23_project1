...
def main():
    ...
    train_dataset = GRUDataset(train_df, vectorizer, fp_len, smiles_enum=smiles_enum, apply_eval=False)
    val_dataset = GRUDataset(val_df, vectorizer, fp_len, smiles_enum=False, apply_eval=False)
    scoring_dataset = GRUDataset(scoring_df, vectorizer, fp_len, smiles_enum=False, apply_eval=False)
